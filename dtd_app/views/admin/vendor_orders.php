...
<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Vendor Orders</h1>
            </div>
        </div>
        <div class="row">
            <div class="col-xs-12">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        Daily Order Summary (Last 15 Days Only)
                    </div>
            ...
            <div class="col-xs-12">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        Daily Order Summary By Vendor (Last 15 Days Only)
                    </div>
                    <div class="panel-body">
                        <table id="example" class="table table-striped table-bordered dttable" cellspacing="0" width="100%">
                            <thead>
                            ...
                            <tr>
                                <th>Total</th>
                                <th></th>
                                <th><?=array_sum(array_column($today_ven,'pending')); ?></th>
                                <th><?=array_sum(array_column($today_ven,'processing')); ?></th>
                                <th><?=array_sum(array_column($today_ven,'delivered')); ?></th>
                                <th><?=array_sum(array_column($today_ven,'returned')); ?></th>
                                <?php foreach($item_types as $it) { ?>
                                    <th><?=array_sum(array_column($today_ven,$it->type_name));?></th>
                                <?php } ?>
                            </tr>
                            </tfoot>
                        </table>
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <table id="example" class="table table-striped table-bordered dttable" cellspacing="0" width="100%">
                            ...
                            <tr>
                                <th>Total</th>
                                <th><?=array_sum(array_column($month,'total_ven')); ?></th>
