    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-xs-12">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        Daily Order Summary By Customer (Last 15 Days Only)
                    </div>
                    <div class="panel-body">
                        <table id="example" class="table table-striped table-bordered dttable" cellspacing="0" width="100%">
                            <thead>
                            ...
                            <tr>
                                <th>Total</th>
                                <th></th>
                                <th><?=array_sum(array_column($today_cust,'pending')); ?></th>
                                <th><?=array_sum(array_column($today_cust,'processing')); ?></th>
                                <th><?=array_sum(array_column($today_cust,'delivered')); ?></th>
                                <th><?=array_sum(array_column($today_cust,'returned')); ?></th>
                                <?php foreach($item_types as $it) { ?>
